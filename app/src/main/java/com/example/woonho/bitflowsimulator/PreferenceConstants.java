...
public class PreferenceConstants {
    ...
    public static final String USER_3GRADE_PERCENT = "user3GradePercent";
    public static final String USER_4GRADE_PERCENT = "user4GradePercent";
    public static final String USER_5GRADE_PERCENT = "user5GradePercent";
    public static final String USER_6GRADE_PERCENT = "user6GradePercent";
    public static final String USER_7GRADE_PERCENT = "user7GradePercent";
    public static final String USER_8GRADE_PERCENT = "user8GradePercent";
